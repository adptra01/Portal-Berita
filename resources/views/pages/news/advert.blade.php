...
state([
    'shop' => fn() => Cache::remember('whatsapp_number', 30, function () {
        return Setting::select('whatsapp', 'title')->first() ?? null;
    }),
]);
                ...
                <div class="container">
                    <div class="row justify-content-center text-center mb-3">
                        <div class="col-lg-8 col-xl-7">
                            <span class="text-muted">Mau Beriklan di <em
                                    class="text-primary fw-semibold">{{ $shop->title }}</em>?</span>
                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="accordion-item border-0 mb-3">
                                    <h2 class="accordion-header" id="headingOne"><button aria-controls="collapseOne"
                                            ...
                                            <span>Mengapa Memilih&nbsp;<strong>{{ $shop->title }}</strong> ?</span>
                                        </button>
                                    </h2>
                    ...
                    <div class="text-center">
                        <a class="genric-btn primary rounded" href="https://wa.me/{{ $shop->whatsapp }}">
                            Hubungi
                        </a>
                    </div>
                </div>
