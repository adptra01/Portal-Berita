...
return Post::with('category')->where('created_at', '>=', Carbon::now()->subWeek(4))->select('slug', 'title', 'thumbnail', 'content', 'viewer', 'category_id', 'created_at')->latest()->paginate(10);
});
...
<div class="container">
    <h3 class="mb-4 fw-bold">Update Terkini</h3>
    <div class="row">
