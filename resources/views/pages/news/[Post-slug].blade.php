...
<x-guest-layout>
    ...
    <div>
        <x-seo-tags :title="$post->title" :description="$ogDescription" :keywords="$post->keyword" :ogTitle="$ogTitle"
            :ogDescription="$ogDescription" :ogImage="$ogThumbnail" :ogimageAlt="$post->title"
            :twitterTitle="$post->title" :twitterDescription="$ogDescription" :twitterImage="$ogThumbnail"
            :author="$post->user->name" :twitterCard="$ogDescription" :ogImageSecure="$ogThumbnail"
            :published_time="$post->created_at" :modified_time="$post->updated_at" :twitterCreator="$post->user->name"
            :articleSection="$post->category->name" :imageUrl="$ogThumbnail" />
        <!-- About US Start -->
