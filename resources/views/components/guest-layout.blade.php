                    ...
                    <div class="container">
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3">
                                <div class="logo">
                                    <a href="index.html">
                                        <img src="{{ asset('/guest/img/logo/logo.png') }}" alt=""></a>
                                </div>
                            </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-10 col-lg-10 col-md-12 header-flex">
                                ...
                                <div class="sticky-logo">
                                    <a href="index.html"><img src="{{ asset('/guest/img/logo/logo.png') }}"
                                            alt=""></a>
                                </div>
                                <!-- Main-menu -->
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="trending-top mb-30">
                                <div class="trend-top-img">
                                    <img src="{{ asset('/guest/img/trending/trending_top.jpg') }}" alt="">
                            ...
                            <div class="trending-bottom">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="single-bottom mb-35">
                                            <div class="trend-bottom-img mb-30">
                                                <img src="{{ asset('/guest/img/trending/trending_bottom1.jpg') }}"
                                                    alt="">
                                            </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="single-bottom mb-35">
                                            <div class="trend-bottom-img mb-30">
                                                <img src="{{ asset('/guest/img/trending/trending_bottom2.jpg') }}"
                                                    alt="">
                                            </div>
                                            <div class="trend-bottom-cap">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="single-bottom mb-35">
                                            <div class="trend-bottom-img mb-30">
                                                <img src="{{ asset('/guest/img/trending/trending_bottom3.jpg') }}"
                                                    alt="">
                                            </div>
                                            <div class="trend-bottom-cap">
                ...
                <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="single-what-news mb-100">
                                                        <div class="what-img">
                                                            <img src="{{ asset('/guest/img/news/whatNews1.jpg') }}"
                                                                alt="">
                                                        </div>
                                                        <div class="what-cap">
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="single-what-news mb-100">
                                                        <div class="what-img">
                                                            <img src="{{ asset('/guest/img/news/whatNews2.jpg') }}"
                                                                alt="">
                                                        </div>
                                                        <div class="what-cap">
                                                            <span class="color1">Night party</span>
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="single-what-news mb-100">
                                                        <div class="what-img">
                                                            <img src="{{ asset('/guest/img/news/whatNews3.jpg') }}"
                                                                alt="">
                                                        </div>
                                                        <div class="what-cap">
                                                            <span class="color1">Night party</span>
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="single-what-news mb-100">
                                                        <div class="what-img">
                                                            <img src="{{ asset('/guest/img/news/whatNews4.jpg') }}"
                                                                alt="">
                                                        </div>
                                                        <div class="what-cap">
                                                            <span class="color1">Night party</span>
                    ...
                    <div class="col-lg-4">
                            ...
                            <div class="single-box">
                                <div class="follow-us d-flex align-items-center">
                                    <div class="follow-social">
                                        <a href="#"><img src="{{ asset('/guest/img/news/icon-fb.png') }}"
                                                alt=""></a>
                                    </div>
                                ...
                                <div class="follow-us d-flex align-items-center">
                                    <div class="follow-social">
                                        <a href="#"><img src="{{ asset('/guest/img/news/icon-tw.png') }}"
                                                alt=""></a>
                                    </div>
                                    <div class="follow-count">
                                        <span>8,045</span>
                                ...
                                <div class="follow-us d-flex align-items-center">
                                    <div class="follow-social">
                                        <a href="#"><img src="{{ asset('/guest/img/news/icon-ins.png') }}"
                                                alt=""></a>
                                    </div>
                                    <div class="follow-count">
                                        <span>8,045</span>
                                ...
                                <div class="follow-us d-flex align-items-center">
                                    <div class="follow-social">
                                        <a href="#"><img src="{{ asset('/guest/img/news/icon-yo.png') }}"
                                                alt=""></a>
                                    </div>
                                    <div class="follow-count">
                                        <span>8,045</span>
                        ...
                        <div class="news-poster d-none d-lg-block">
                            <img src="{{ asset('/guest/img/news/news_card.jpg') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="weekly2-news-active dot-style d-flex dot-style">
                                <div class="weekly2-single">
                                    <div class="weekly2-img">
                                        <img src="{{ asset('/guest/img/news/weekly2News1.jpg') }}" alt="">
                                    </div>
                                ...
                                <div class="weekly2-single">
                                    <div class="weekly2-img">
                                        <img src="{{ asset('/guest/img/news/weekly2News2.jpg') }}" alt="">
                                    </div>
                                    <div class="weekly2-caption">
                                ...
                                <div class="weekly2-single">
                                    <div class="weekly2-img">
                                        <img src="{{ asset('/guest/img/news/weekly2News3.jpg') }}" alt="">
                                    </div>
                                    <div class="weekly2-caption">
                                        <span class="color1">Corporate</span>
                                        <p>25 Jan 2020</p>
                                ...
                                <div class="weekly2-single">
                                    <div class="weekly2-img">
                                        <img src="{{ asset('/guest/img/news/weekly2News4.jpg') }}" alt="">
                                    </div>
                                    <div class="weekly2-caption">
                        ...
                        <div class="single-footer-caption">
                            <div class="single-footer-caption">
                                ...
                                <div class="footer-logo">
                                    <a href="index.html"><img src="{{ asset('/guest/img/logo/logo2_footer.png') }}"
                                            alt=""></a>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-6">
                        <div class="single-footer-caption mb-50 mt-60">
                            ...
                            <div class="instagram-gellay">
                                <ul class="insta-feed">
                                    <li><a href="#"><img src="{{ asset('/guest/img/post/instra1.jpg') }}"
                                                alt=""></a>
                                    </li>
                                    <li><a href="#"><img src="{{ asset('/guest/img/post/instra2.jpg') }}"
                                                alt=""></a>
                                    </li>
                                    <li><a href="#"><img src="{{ asset('/guest/img/post/instra3.jpg') }}"
                                                alt=""></a>
                                    </li>
                                    <li><a href="#"><img src="{{ asset('/guest/img/post/instra4.jpg') }}"
                                                alt=""></a>
                                    </li>
                                    <li><a href="#"><img src="{{ asset('/guest/img/post/instra5.jpg') }}"
                                                alt=""></a>
                                    </li>
                                    <li><a href="#"><img src="{{ asset('/guest/img/post/instra6.jpg') }}"
                                                alt=""></a>
                                    </li>
                                </ul>
                            </div>
