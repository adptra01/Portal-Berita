            ...
            <div class="trending-bottom">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="single-bottom mb-35">
                            <div class="trend-bottom-img mb-30">
                                <img src="{{ asset('/guest/img/trending/trending_bottom1.jpg') }}" alt="">
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="single-bottom mb-35">
                            <div class="trend-bottom-img mb-30">
                                <img src="{{ asset('/guest/img/trending/trending_bottom2.jpg') }}" alt="">
                            </div>
                            <div class="trend-bottom-cap">
                    ...
                    <div class="col-lg-4">
                        <div class="single-bottom mb-35">
                            <div class="trend-bottom-img mb-30">
                                <img src="{{ asset('/guest/img/trending/trending_bottom3.jpg') }}" alt="">
                            </div>
                            <div class="trend-bottom-cap">
