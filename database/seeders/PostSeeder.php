...
class PostSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $response = Http::get('https://api-berita-indonesia.vercel.app/antara/ekonomi/'); // category : politik, hukum, ekonomi, bola, olahraga, humaniora, lifestyle, hiburan, dunia, tekno, otomotif
