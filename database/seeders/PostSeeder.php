...
class PostSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $response = Http::get('https://api-berita-indonesia.vercel.app/antara/tekno/'); // category : politik, hukum, ekonomi, bola, olahraga, humaniora, lifestyle, hiburan, dunia, tekno, otomotif
